    ...
    <div className="relative mx-auto w-full max-w-lg rounded-3xl bg-[#1a2025]/70 backdrop-blur-xl">
      ...
      <form onSubmit={submit} className="mb-6 flex flex-col gap-6 px-5 pt-16">
        ...
        {isConnected ? (
          ...
          <button
            className="relative flex w-full animate-pulse items-center justify-center gap-2 rounded-xl bg-primary py-4 px-6 text-lg font-semibold text-secondary transition-opacity duration-200 hover:opacity-75 disabled:cursor-not-allowed disabled:opacity-80 lg:text-xl"
            disabled={loading}
            type="button"
            onClick={() => open()}
          >
      ...
      <a href="https://pinky.finance" target="_blank" title="Pinky Finance | Web 3.0 File Marketplace" className="pb-4 flex flex-row justify-center">Powered by <img src="https://www.pinky.finance/images/dark-logo.svg" className="h-6 pl-2" /></a>
    </div>
  );
};
